...
const Footer = () => {
    return (
        <footer className="py-20 md:py-40 bg-gray-900">
                ...
                <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
                    <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
                        <div className="flex w-full justify-center space-x-12 text-gray-300 sm:w-7/12 md:justify-start">
                            <ul className="list-inside space-y-8 list-none">
                                <li>
                                ...
                                <li>
                                    <a href="#" className="transition ">
                                        Benifits for clients
                                    </a>
                                </li>
                                <li>
                                    <a href="#" className="transition ">
                                    Benifits for Freelancers
                                    </a>
                                </li>
                                <li>
                                    <a href="#" className="transition ">

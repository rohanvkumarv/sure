    ...
    <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
            ...
            <div className="space-y-2">
                <h5 className="text-xl font-semibold text-white transition group-hover:text-custom">
                Step one
                </h5>
                <p className="text-gray-300">
                Upload Files and Provide Project Details
                </p>
            </div>
            <a
                href="#"
                className="flex items-center justify-between group-hover:text-custom"
            >
    ...
    <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
            ...
            <div className="space-y-2">
                ...
                <p className="text-gray-300">
               Verification and Account Creations
                </p>
            </div>
            <a
                href="#"
    ...
    <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
            ...
            <div className="space-y-2">
                ...
                <p className="text-gray-300">
                Redirect to Preview and Payment Page
                </p>
            </div>
            <a
                href="#"

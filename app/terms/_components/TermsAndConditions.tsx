...
const TermsAndConditions = () => {
  return (
    ...
    <div style={styles.body} className="relative ">
      ...
      <div style={styles.container} className="bg-gray-800 rounded-3xl relative pt-36 ml-auto">
        <div style={styles.p} className="text-gray-300 text-align-left">
       
            <div style={styles.textContainer}>
              

              <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>   TERMS AND CONDITIONS </h2>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '> 4. USER REGISTRATION</h2>
  <p  className='text-gray-300'>
  
  
  You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
  </p>
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>5. PURCHASES AND PAYMENT</h2>
  <p  className='text-gray-300'>
  
                We accept the following forms of payment:
                upi -  debit card -  PayPal -  Visa -  Mastercard  
                
                You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in inr.  You agree to pay all charges at the prices then in effect for your purchases and any applicable shipping fees, and you authorise us to charge your chosen payment provider for any such amounts upon placing your order. We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or received payment.  We reserve the right to refuse any order placed through the Services. We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order. These restrictions may include orders placed by or under the same customer account, the same payment method, and/or orders that use the same billing or shipping address. We reserve the right to limit or prohibit orders that, in our sole judgement, appear to be placed by dealers, resellers, or distributors.
  
                </p>
                <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>   6. SUBSCRIPTIONS</h2>
                <p  className='text-gray-300'>
               
                Billing and Renewal
                by their dashboard and reminder
                Free Trial 
                We offer a 30-day free trial to new users who register with the Services. The account will not be charged and the subscription will be suspended until upgraded to a paid version at the end of the free trial.Cancellation 
                raising a refund issue Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at rohanvkumarv@gmail.com.
                Fee Changes 
                We may, from time to time, make changes to the subscription fee and will communicate any price changes to you in accordance with applicable law.
  </p>
  
              
                <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  7. Prohibited Activities</h2>
                
      <p className='text-gray-300'>You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
      
      <p className='text-gray-300'>As a user of the Services, you agree not to:</p>
      <ul>
          ...
          <li>Breach terms and conditions.</li>
          <li>Take payment outside of the platform.</li>
          <li>Attempt to download paid media.</li>
      </ul>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>8. USER GENERATED CONTRIBUTIONS</h2>
                <p  className='text-gray-300'>
  ...
  Any use of the Services in violation of the foregoing violates these Legal Terms and may result in, among other things, termination or suspension of your rights to use the Services.
      ...
      <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>   9. Contribution License</h2>
      <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  10. Guidelines for Reviews</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  11. Social Media</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  12. Services Management</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  13. Privacy Policy</h2>
  <p  className='text-gray-300'>
  We care about data privacy and security. Please review our Privacy Policy: [https://sure-jade.vercel.app/policy](https://sure-jade.vercel.app/policy). By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, then through your continued use of the Services, you are transferring your data to India, and you expressly consent to have your data transferred to and processed in India.
  </p>
  
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '> 14. Term and Termination</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  15. Modifications and Interruptions</h2>
  <p  className='text-gray-300'>
  We reserve the right to change, modify, or remove the contents of the Services at any time or for any reason at our sole discretion without notice. However, we have no obligation to update any information on our Services. We will not be liable to you or any third party for any modification, price change, suspension, or discontinu
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  16. Governing Law</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  17. Dispute Resolution</h2>
  <p  className='text-gray-300'>
  ...
  If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the Indian Arbitration Association ("IAA") and, where appropriate, the IAA’s Supplementary Procedures for Consumer Related Disputes ("IAA Consumer Rules"), both of which are available at the IAA website: [www.adr.org](www.adr.org). Your arbitration fees and your share of arbitrator compensation shall be governed by the IAA Consumer Rules and, where appropriate, limited by the IAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable IAA rules or applicable law, the arbitration will take place in Mumbai, India. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.
  
  If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Mumbai, India, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) is excluded from these Legal Terms.
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '> 18. Corrections</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  19. Disclaimer</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  20.Limitations of Liability</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>  21. Indemnification</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '> 22. User Data</h2>
  <p  className='text-gray-300'>
  We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
  </p>
  
  
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>23. Electronic Communications, Transactions, and Signatures</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>24. SMS TEXT MESSAGING</h2>
  <p  className='text-gray-300'>
  Opting Out
  If at any time you wish to stop receiving SMS messages from us, simply reply to the text with "STOP.” You may receive an SMS message confirming your opt out.
  
  Message and Data Rates
  APlease be aware that message and data rates may apply to any SMS messages sent or received. The rates are determined by your carrier and the specifics of your mobile plan.
  Support
  If you have any questions or need assistance regarding our SMS communications, please email us at rohanvkumarv@gmail.com or call at 06395335690
  </p>
  
  
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>25. Miscellaneous</h2>
  <p  className='text-gray-300'>
  ...
  <h2 className=' my-8 text-2xl font-bold text-white md:text-4xl '>26. CONTACT US</h2>
  <p  className='text-gray-300'>
